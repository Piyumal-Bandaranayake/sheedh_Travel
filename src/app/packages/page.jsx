      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {packages.map((pkg) => (
              <div key={pkg.id} className="bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 flex flex-col group">
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <p className="text-dark-gray mb-6 flex-1 line-clamp-3">{pkg.desc}</p>
                  <div className="flex flex-col gap-3">
                    <button 
                      onClick={() => openModal(pkg)}
                      className="w-full py-3 border-2 border-primary text-primary font-semibold rounded-lg text-center hover:bg-primary hover:text-white transition-all duration-300"
                    >
                      View Full Details
                    </button>
