            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              <div className="lg:col-span-4">
                <div className="sticky top-32 p-10 bg-primary rounded-[2.5rem] text-white shadow-2xl shadow-primary/30 order-first lg:order-last">
                  ...
                  <button className="w-full py-5 bg-secondary text-white font-black rounded-2xl text-lg hover:bg-red-700 hover:scale-[1.02] transform transition-all duration-300 shadow-xl shadow-red-500/30 mb-4">
                    Inquire Now
                  </button>
