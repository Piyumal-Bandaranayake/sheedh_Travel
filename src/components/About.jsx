...
const About = () => {
  return (
    <div id="about" className="py-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2">
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-10 -right-6 bg-secondary text-white p-8 rounded-[2rem] shadow-2xl hidden lg:block transform hover:scale-105 transition-transform duration-300">
                <p className="text-4xl font-black">10+</p>
                <p className="text-sm font-bold uppercase tracking-wider opacity-90">Years Experience</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-primary mb-8 leading-[1.1]">
              Crafting Unforgettable <br/> <span className="text-secondary italic">Sri Lankan</span> Journeys
            </h2>
