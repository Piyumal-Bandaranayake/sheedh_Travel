            ...
            <div key={vehicle.id} className="group bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col">
              ...
              <div className="p-6 md:p-7 flex-1 flex flex-col">
                ...
                <div className="mt-auto">
                  <button className="w-full bg-[#25D366] text-white py-3.5 rounded-xl font-bold hover:bg-[#128C7E] transition-all shadow-lg active:scale-95 text-sm uppercase tracking-wider flex items-center justify-center gap-2">
