              ...
              <div className="p-6 md:p-7 flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between mt-auto">
                  <div className="flex flex-col">
                    ...
                    <span className="text-lg md:text-xl font-black text-primary">{vehicle.price}</span>
                  </div>
                  <button className="bg-primary text-white w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center hover:bg-secondary transition-all hover:scale-110 shadow-xl group/btn active:scale-95">
