    ...
    <footer className="bg-primary text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
          {/* Brand */}
          <div>
            <h2 className="text-xl font-bold mb-4 italic tracking-tighter">Sheedh</h2>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-secondary transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70 text-sm">
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-secondary shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                </svg>
                456 Galle Road, Colombo, Sri Lanka
              </li>
              <li className="flex gap-3">
                <svg className="w-4 h-4 text-secondary shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
